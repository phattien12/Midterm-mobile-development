 ...
 * Use the {@link SystemCertificationsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SystemCertificationsFragment extends Fragment implements OnRecyclerViewItemCertificationClickListener {

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private FragmentSystemCertificationsBinding binding;
    private HomeDataViewModel homeDataViewModel;
    private SystemCertificationAdapter adapter;
    ...
    public SystemCertificationsFragment() {
    ...
    public static SystemCertificationsFragment newInstance(String param1, String param2) {
        SystemCertificationsFragment fragment = new SystemCertificationsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSystemCertificationsBinding.inflate(inflater, container, false);
        getVM();
        adapter = new SystemCertificationAdapter(
                requireContext(),
