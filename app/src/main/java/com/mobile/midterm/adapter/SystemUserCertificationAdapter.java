...
public class SystemUserCertificationAdapter extends RecyclerView.Adapter<SystemUserCertificationAdapter.SystemCertificationHolder> {
    ...
    public SystemUserCertificationAdapter(Context context, User user, List<Certification> certifications, int layout, OnRecyclerViewItemCertificationClickListener on) {
