...
import com.mobile.midterm.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.viewUserListBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onSelectedBottomNavbarItem.onSelectedNavbarItem(R.id.systemUsersTab);
            }
        });
        binding.addUserBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent addUserScreen = new Intent(requireActivity(), AddUserActivity.class);
